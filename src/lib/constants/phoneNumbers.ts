...
export const SEEKER_OFFER_CODE = "DISCOVER"; // TODO: update when phone team confirms new code
export const SEEKER_OFFER_LABEL = "Seeker Offer";
export const SEEKER_OFFER_PRICE = "10 mins for £5";
