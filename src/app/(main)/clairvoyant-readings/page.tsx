...
export const metadata = {
  ...
  alternates: { canonical: "/clairvoyant-readings" },
};
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbJsonLd([{ name: "Clairvoyant Readings", path: "/clairvoyant-readings" }])) }}
      />
